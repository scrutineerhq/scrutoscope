...
### Fixed
- Trimmed plugin tags to wp.org 5-tag limit (was silently dropping 7 tags)
- Fixed PHPCS alignment warnings in Profiler.php and Report.php
...
### Fixed
- Replaced `rename()` with `$wp_filesystem->move()` for mu-plugin migration (Schema.php)
